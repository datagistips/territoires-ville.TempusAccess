...
from Ui_manageRoadNetworkDialog import Ui_Dialog

class manageRoadNetworkDialog(QDialog): 
    ...
    def __init__(self, caller, iface):
        ...
        self.ui.comboBoxSourceName.setModel(self.caller.modelRoadNetworkSources)
