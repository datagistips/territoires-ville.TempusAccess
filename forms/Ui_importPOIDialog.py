...
#
# Created: Wed Oct 31 09:08:35 2018
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(467, 254)
        self.buttonBox = QtGui.QDialogButtonBox(Dialog)
        self.buttonBox.setGeometry(QtCore.QRect(380, 210, 81, 31))
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Close)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.layoutWidget = QtGui.QWidget(Dialog)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 11, 451, 191))
        ...
        self.pushButtonChoose.setEnabled(True)
        ...
        self.gridLayout.addWidget(self.pushButtonChoose, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelPath, 6, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_6.setText(_translate("Dialog", "Nom de la source *", None))
