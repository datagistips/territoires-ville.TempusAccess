...
#
# Created: Tue Nov 20 15:34:22 2018
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(463, 432)
        self.buttonBox = QtGui.QDialogButtonBox(Dialog)
        self.buttonBox.setGeometry(QtCore.QRect(360, 390, 81, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Close)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.layoutWidget = QtGui.QWidget(Dialog)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 10, 441, 41))
        ...
        self.labelLoadedDB = QtGui.QLabel(self.layoutWidget)
        self.labelLoadedDB.setAlignment(QtCore.Qt.AlignCenter)
        self.labelLoadedDB.setObjectName(_fromUtf8("labelLoadedDB"))
        self.gridLayout.addWidget(self.labelLoadedDB, 0, 1, 1, 2)
        self.groupBox = QtGui.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(10, 70, 441, 201))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.layoutWidget1 = QtGui.QWidget(self.groupBox)
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 30, 401, 121))
        self.layoutWidget1.setObjectName(_fromUtf8("layoutWidget1"))
        self.gridLayout_2 = QtGui.QGridLayout(self.layoutWidget1)
        self.gridLayout_2.setMargin(0)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.labelRouteDataSize = QtGui.QLabel(self.layoutWidget1)
        ...
        self.labelPTDataSize = QtGui.QLabel(self.layoutWidget1)
        ...
        self.label_197 = QtGui.QLabel(self.layoutWidget1)
        ...
        self.label_196 = QtGui.QLabel(self.layoutWidget1)
        ...
        self.labelIndicDataSize = QtGui.QLabel(self.layoutWidget1)
        ...
        self.labelAuxDataSize = QtGui.QLabel(self.layoutWidget1)
        ...
        self.comboBoxDB = QtGui.QComboBox(self.layoutWidget1)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(10, 280, 441, 101))
