...
<qgis version="2.18.26" simplifyAlgorithm="0" minimumScale="100000" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="0" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="route_type" forceraster="0" symbollevels="0" type="categorizedSymbol" enableorderby="0">
    <categories>
      <category render="true" symbol="0" value="0" label="Arrêt de tram"/>
      <category render="true" symbol="1" value="1" label="Arrêt de métro"/>
      <category render="true" symbol="2" value="2" label="Arrêt ferroviaire"/>
      <category render="true" symbol="3" value="3" label="Arrêt d'autocar"/>
      <category render="true" symbol="4" value="4" label="Arrêt de ferry"/>
      <category render="true" symbol="5" value="5" label="Arrêt de transport par câble (au sol)"/>
      <category render="true" symbol="6" value="6" label="Arrêt de transport par câble (aérien)"/>
      <category render="true" symbol="7" value="7" label="Arrêt de funiculaire"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/scaleMax" value="-999999999"/>
  ...
  <aliases>
    ...
    <alias field="feed_id" index="2" name=""/>
    <alias field="stop_id" index="3" name=""/>
    <alias field="stop_name" index="4" name=""/>
    <alias field="zone_id" index="5" name=""/>
    <alias field="stop_url" index="6" name=""/>
    <alias field="location_type" index="7" name=""/>
    <alias field="parent_station_id" index="8" name=""/>
