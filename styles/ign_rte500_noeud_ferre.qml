...
<qgis version="2.18.8" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="toponyme">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="id_troncon">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="id_commune">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{47fd46c0-c057-413c-9639-fd3dfceef0b4}">
      <rule filter="nature='Gare de voyageurs' or nature='Gare de voyageurs et de fret'" key="{3c499bed-11a9-4a66-a278-9bce69a0144e}" symbol="0"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="nature" index="2" name=""/>
    <alias field="toponyme" index="3" name=""/>
    <alias field="id_troncon" index="4" name=""/>
    <alias field="id_commune" index="5" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;nature&quot;" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="ogc_fid"/>
      <column width="-1" hidden="0" type="field" name="id_rte500"/>
      <column width="241" hidden="0" type="field" name="nature"/>
      <column width="-1" hidden="0" type="field" name="toponyme"/>
      <column width="-1" hidden="0" type="field" name="id_troncon"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="toponyme" expression=""/>
    <default field="id_troncon" expression=""/>
    <default field="id_commune" expression=""/>
  </defaults>
